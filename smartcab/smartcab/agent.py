...
class LearningAgent(Agent):
    ...
    def choose_action(self, state):
        ...
        # When learning, choose a random action with 'epsilon' probability
            ...
            print(maxQ)
            action = np.random.choice([act for act, val in self.Q[state].items() if val == maxQ])
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning and self.epsilon > 0.01:
            print("Still learning.....")
            current_reward = self.Q[state][action]
            self.Q[state][action] += self.alpha*(reward - current_reward)
